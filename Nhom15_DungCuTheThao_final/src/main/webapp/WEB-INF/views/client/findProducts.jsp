                ...
                <div class="col-lg-9">
                    <div class="row">
                        <div class="col-md-6 pb-4">
                            <div class="d-flex">
                                <h3 class="title" style="margin-right: 10px">Tìm ${nameP}</h3>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <c:forEach items="${productz}" var="product">
                            <div class="col-md-4">
                                <div class="card mb-4 product-wap rounded-0" id="sanpham">
                                    ...
                                    <div class="card-body" style="height: 51px; ">
                                        <a href="shop-single.html" class="h3 text-decoration-none">${product.productName}</a>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <c:if test="${product.saleDTO.percent == 0}">
                                            ...
                                            <p class="text-center mb-0 font-weight-bold">${product.price - (product.price * product.saleDTO.percent / 100)}0 VNĐ</p>
                                        </c:if>
                                        <c:if test="${product.saleDTO.percent != 0}">
                                            <ul class="list-unstyled d-flex justify-content-center mb-1">
                                                <li style="text-decoration: line-through; opacity: 0.4">${product.price}0 VNĐ</li>
                                            </ul>
                                            <p class="text-center mb-0 font-weight-bold">${product.price - (product.price * product.saleDTO.percent / 100)}0 VNĐ</p>
                                        </c:if>
                                    </div>
                    ...
                    <jsp:include page="common/toolbarFindProducts.jsp" />
                </div>
            </div>
        </div>
