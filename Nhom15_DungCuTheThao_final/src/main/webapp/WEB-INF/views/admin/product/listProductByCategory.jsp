                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="vertical-align: middle;"><span
                                                            style="color: #41B314; font-weight: bold;">$${product.price
                                                                                                      - (product.price * (product.saleDTO.percent / 100))}0</span><br />
                                ...
                                <!-- /.table-stats -->
                                <div class="card-footer" style="margin-right: -100px">
                                    <ul class="pagination">
                                        <c:forEach begin="0" end="${totalPage - 1}" var="i">
                                            <li class="page-item"><a class="page-link" 
                                                                     ...
                                                                     style="margin: 0 -15px 0 -15px" href="product-list-by-category?categoryId=${categoryId}&pageIndex=${i}">${i + 1}</a></li>
                                            </c:forEach>
                                    </ul>
                                </div>
                            </div>
